...
MissileWeaponData missile_data[MW_Count] =
{
    ...
    MissileWeaponData(200.0f, 10.f, 54.0f, sf::Color(255, 200, 0), 1200.0),/*MW_Homing*/
    MissileWeaponData(200.0f, 10.f, 54.0f, sf::Color(255, 100, 32), 500.0),/*MW_Nuke*/
    ...
    MissileWeaponData(200.0f, 10.f, 54.0f, sf::Color(100, 32, 255), 500.0),/*MW_EMP*/
    MissileWeaponData(500.0f,  0.f, 27.0f, sf::Color(200, 200, 200), 0.0),/*MW_HVLI*/
};
