...
fire_sound(fire_sound), damage_multiplier(1), basetype(base_type), fire_count(1) , lined_count(1),damage_type(dt)
{
}
...
void CustomMissileWeaponRegistry::createMissileWeapon(const EMissileWeapons &iBaseType, const std::string &iNewName, const float &iDamageMultiplier, const float &iSpeed, const int& iFireCount, const int &iLineCount, const EDamageType &iDT)
{
