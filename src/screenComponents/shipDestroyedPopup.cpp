...
: GuiElement(owner, "SHIP_DESTROYED_POPUP"), owner(owner)
{
    ...
    (new GuiLabel(ship_destroyed_overlay, "SHIP_DESTROYED_TEXT", "VAISSEAU DETRUIT!", 70))->setPosition(0, 0, ACenter)->setSize(500, 100);
    (new GuiButton(ship_destroyed_overlay, "SHIP_DESTROYED_BUTTON", "Retour", [this]() {
        this->owner->destroy();
        soundManager->stopMusic();
        returnToShipSelection();
    }))->setPosition(0, 75, ACenter)->setSize(500, 50)->hide();
