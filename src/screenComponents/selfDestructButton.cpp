...
: GuiElement(owner, id)
{
    activate_button = new GuiButton(this, id + "_ACTIVATE", "Auto destruction", [this](){
    ...
    confirm_button = new GuiButton(this, id + "_CONFIRM", "Confirmer !", [this](){
        confirm_button->hide();
        if (my_spaceship)
    ...
    cancel_button = new GuiButton(this, id + "_CANCEL", "Annuler", [this](){
