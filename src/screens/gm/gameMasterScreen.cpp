...
: click_and_drag_state(CD_None)
{
    ...
    intercept_comms_button = new GuiToggleButton(this, "INTERCEPT_COMMS_BUTTON", "Capter les comms", [this](bool value) {
...
: GuiOverlay(gm_screen, "OBJECT_CREATE_SCREEN", sf::Color(0, 0, 0, 128))
{
    ...
    (new GuiButton(box, "CREATE_WARP_JAMMER", "Bloqueur Warp", [this]() {
