...
variation:setShields(15)
variation:setSpeed(140, 12, 15)
...
--                  Arc, Dir, Range, CycleTime, Dmg
template:setBeam(0, 15, 0, 2000.0, 7.0, 50)
--                                Arc, Dir, Rotate speed
template:setBeamWeaponTurret( 0, 100, 0, 6)
--       Tubes
...
template:setCustomWeaponStorage("SEEK", 10)
...
template:setCustomWeaponStorage("TEMP", 10)
-- Autocanon : (rafale longue , degat faible)
template:setCustomWeapon("HVLI", "AC", 1.5, 1200.0, 4, "Kinetic")
template:setCustomWeaponColor("AC", 255, 51, 0)
template:setCustomWeaponStorage("AC", 20)
...
template:setRadarTrace("radar_fighter.png")
template:setDescription([[Ce chasseur stellaire est l'un des moins proteges en service actif, ses deux lanceurs peuvent donner un coup de poing. Son objectif est de voler, detruire sa cible et repartir ou etre detruit.]])
template:setHull(80)
template:setShields(40)
template:setSpeed(60, 28, 25)
template:setJumpDrive(true)
--                  Arc, Dir, Range, CycleTime, Dmg
template:setBeam(0, 15, 1, 1500.0, 1.5, 3)
template:setBeam(1, 15, -1, 1500.0, 1.5, 3)
--                                Arc, Dir, Rotate speed
template:setBeamWeaponTurret( 0, 150, 0, 6)
template:setBeamWeaponTurret( 1, 150, 0, 6)
--       Tubes
