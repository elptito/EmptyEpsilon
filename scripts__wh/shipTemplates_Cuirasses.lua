...
template:setBeam(3, 90, 90, 2000.0, 7.0, 50)
template:setBeam(4, 90, -90, 2000.0, 7.0, 50)
template:setBeam(5, 90, 90, 1500.0, 1.5, 12)
template:setBeam(6, 90,-90, 1500.0, 1.5, 12)
template:setBeam(7, 90, 90, 1500.0, 1.5, 12)
template:setBeam(8, 90,-90, 1500.0, 1.5, 12)
